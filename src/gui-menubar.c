...
mo_status mo_set_fonts (mo_window *win, int size)
{
  switch (size)
    ...
    case mo_large_fonts:
      ...
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-34-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-25-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-adobe-times-medium-i-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-adobe-times-medium-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_regular_fonts:
      ...
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      ...
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_small_fonts:
      ...
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-times-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-adobe-times-medium-i-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-adobe-times-medium-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_large_helvetica:
      ...
      XmxSetArg (WbNfixedboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-34-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-25-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-adobe-helvetica-medium-o-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-adobe-helvetica-medium-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetValues (win->scrolled_win);
      win->font_family = 1;
      break;
    case mo_regular_helvetica:
      ...
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      ...
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_small_helvetica:
      ...
      XmxSetArg (WbNfixedboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-helvetica-bold-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_large_newcentury:
      ...
      XmxSetArg (WbNfixedboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-34-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-25-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_small_newcentury:
      ...
      XmxSetArg (WbNfixedboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-i-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetValues (win->scrolled_win);
      win->font_family = 2;
      break;
    case mo_regular_newcentury:
      XmxSetArg (XtNfont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNitalicFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-i-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNboldFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixedFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixedboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-25-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-20-*-*-*-*-*-*-*"));
      ...
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-adobe-new century schoolbook-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-i-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-adobe-courier-medium-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-adobe-courier-bold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-adobe-new century schoolbook-medium-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_large_lucidabright:
      ...
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-34-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-25-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-b&h-lucidabright-medium-i-normal-*-20-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-b&h-lucidatypewriter-medium-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-b&h-lucidatypewriter-bold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-17-*-*-*-*-*-*-*"));
    ...
    case mo_regular_lucidabright:
      ...
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-20-*-*-*-*-*-*-*"));
      ...
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-b&h-lucidabright-medium-r-normal-*-11-*-*-*-*-*-*-*"));
    ...
    case mo_small_lucidabright:
      ...
      XmxSetArg (WbNfixeditalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader1Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-17-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader2Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader3Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader4Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader5Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNheader6Font, (XtArgVal)wrapFont("-b&h-lucidabright-demibold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNaddressFont, (XtArgVal)wrapFont("-b&h-lucidabright-medium-i-normal-*-14-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainFont, (XtArgVal)wrapFont("-b&h-lucidatypewriter-medium-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainboldFont, (XtArgVal)wrapFont("-b&h-lucidatypewriter-bold-r-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNplainitalicFont, (XtArgVal)wrapFont("-adobe-courier-medium-o-normal-*-11-*-*-*-*-*-*-*"));
      XmxSetArg (WbNsupSubFont, (XtArgVal)wrapFont("-b&h-lucidabright-medium-r-normal-*-11-*-*-*-*-*-*-*"));
...
/* removed 5/17/96 - bjs 
    ...
    case mo_delay_image_loads:
      ...
      XmxSetArg (WbNdelayImageLoads, 
      		(XtArgVal)(win->delay_image_loads ? True : False));
      XmxSetValues (win->scrolled_win);
